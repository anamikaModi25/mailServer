...
exports.Connection = exports.severusClient = exports.stageClient = void 0;
var pg_1 = require("pg");
var stageParams = {
    user: 'deadpool',
    password: 'mikealph@',
...
exports.stageClient = new pg_1.Pool({
...
exports.severusClient = new pg_1.Pool({
...
var Connection = /** @class */ (function () {
    ...
    Connection.getOpenConnection = function (client) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(this.instance !== null)) return [3 /*break*/, 1];
